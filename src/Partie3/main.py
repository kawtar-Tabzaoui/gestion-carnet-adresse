...
#pour wach ba9i ba4ina n supprimi, et une fois nmodifier f fichier manuellement, nji afficher 3awtani les contacts f application ykon tbasa 3la fichier jdid